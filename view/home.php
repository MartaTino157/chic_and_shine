...
<div class="title-body">
	...
	<div class="title-body">
		<div class="row">
			...
			<div class="col-md-6">
				<p>Если вы не можете самостоятельно определиться с дизайном маникюра, то предварительно, на сайте нашего маникюрного салона, можно выбрать оодин из уже реализованных вариантов, посмотрев <a href="galery" id="3">фото работ мастеров</a> в соответствующих разделах.</p>
			</div>
		</div>
	</div>
